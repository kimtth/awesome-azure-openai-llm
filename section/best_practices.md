...
- [AI Book: RAG Optimization Strategies (Chinese)](https://aibook.ren/archives/ai-rag-advanced-optimization)✍️: Practical guide covering context-aware chunking, reranking, query expansion, multi-query RAG, Agentic RAG, self-reflection, and knowledge graph enhanced RAG. [2026]
