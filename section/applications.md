...
- [GitNexus✨](https://github.com/abhigyanpatwari/GitNexus): Indexes codebases into a knowledge graph and exposes it via MCP tools for AI agents. [Aug 2025] ![**github stars**](https://img.shields.io/github/stars/abhigyanpatwari/GitNexus?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [openrag✨](https://github.com/linagora/openrag): Open source, modular, lightweight, extensible RAG application stack. ![**github stars**](https://img.shields.io/github/stars/linagora/openrag?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [Semantica✨](https://github.com/Hawksight-AI/semantica): Semantic intelligence layer that makes your AI agents auditable, explainable, and compliant — beyond Text Similarity [Jun 2025] ![**github stars**](https://img.shields.io/github/stars/Hawksight-AI/semantica?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [UltraRAG✨](https://github.com/OpenBMB/UltraRAG): A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines [Jan 2025] ![**github stars**](https://img.shields.io/github/stars/OpenBMB/UltraRAG?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [UniversalRAG✨](https://github.com/wgcyeo/UniversalRAG): RAG framework that retrieves across multiple modalities. [29 Apr 2025]  ![**github stars**](https://img.shields.io/github/stars/wgcyeo/UniversalRAG?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
- [zvec✨](https://github.com/alibaba/zvec): Lightweight vector database by Alibaba Cloud. [Dec 2025] ![**github stars**](https://img.shields.io/github/stars/alibaba/zvec?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [DataAgent✨](https://github.com/spring-ai-alibaba/DataAgent): Spring AI Alibaba DataAgent. [Sep 2025] ![**github stars**](https://img.shields.io/github/stars/spring-ai-alibaba/DataAgent?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [hive✨](https://github.com/adenhq/hive): Outcome driven agent development framework that evolves [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/adenhq/hive?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [ralph✨](https://github.com/snarktank/ralph): an autonomous AI agent loop that runs Amp repeatedly until all PRD items are complete. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/snarktank/ralph?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [Copilot SDK✨](https://github.com/github/copilot-sdk): Multi-platform SDK for integrating GitHub Copilot Agent into apps and services [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/github/copilot-sdk?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
Context management for Claude Code. Hooks maintain state via ledgers and handoffs. [Dec 2025] ![**github stars**](https://img.shields.io/github/stars/parcadei/Continuous-Claude-v3?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [ART✨](https://github.com/OpenPipe/ART): Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. [Mar 2025] ![**github stars**](https://img.shields.io/github/stars/OpenPipe/ART?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [cai✨](https://github.com/aliasrobotics/cai): Security-focused AI agent framework for offensive and defensive workflows. ![**github stars**](https://img.shields.io/github/stars/aliasrobotics/cai?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [googleworkspace/cli✨](https://github.com/googleworkspace/cli): Workspace automation CLI for AI-assisted docs, mail, and calendar tasks. ![**github stars**](https://img.shields.io/github/stars/googleworkspace/cli?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [DeepTutor✨](https://github.com/HKUDS/deeptutor): Personalized AI learning tutor for interactive education [Oct 2024] ![**github stars**](https://img.shields.io/github/stars/HKUDS/deeptutor?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [dash✨](https://github.com/agno-agi/dash): Self-learning data agent built with Agno.  Inspired by OpenAI's in-house implementation. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/agno-agi/dash?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [pentagi✨](https://github.com/vxcontrol/pentagi): Autonomous AI system for penetration testing with 20+ security tools and sandboxed execution. [Jan 2025] ![**github stars**](https://img.shields.io/github/stars/vxcontrol/pentagi?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [ludwig✨](https://github.com/ludwig-ai/ludwig): Low-code framework for building custom LLMs and other AI models. ![**github stars**](https://img.shields.io/github/stars/ludwig-ai/ludwig?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [visual-explainer✨](https://github.com/nicobailon/visual-explainer): Generates rich HTML pages or slide decks for diagrams and reviews. ![**github stars**](https://img.shields.io/github/stars/nicobailon/visual-explainer?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [CoPaw✨](https://github.com/agentscope-ai/CoPaw): Your Personal AI Assistant; easy to install, deploy on your own machine or on the cloud. ![**github stars**](https://img.shields.io/github/stars/agentscope-ai/CoPaw?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [NemoClaw✨](https://github.com/NVIDIA/NemoClaw): NVIDIA agent framework for open, multimodal task execution. ![**github stars**](https://img.shields.io/github/stars/NVIDIA/NemoClaw?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [office-agents✨](https://github.com/hewliyang/office-agents): Agents for Office documents, spreadsheets, and presentations. ![**github stars**](https://img.shields.io/github/stars/hewliyang/office-agents?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [OpenPPT✨](https://github.com/YOOTeam/OpenPPT): Presentation generation and editing driven by AI workflows. ![**github stars**](https://img.shields.io/github/stars/YOOTeam/OpenPPT?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [picoclaw✨](https://github.com/sipeed/picoclaw): AI assistant in Go for $10 hardware — <10MB RAM, 1s boot, runs on RISC-V/ARM/x86. [Feb 2026] ![**github stars**](https://img.shields.io/github/stars/sipeed/picoclaw?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [zeroclaw✨](https://github.com/zeroclaw-labs/zeroclaw): Zero-shot agent toolkit for extending autonomous workflows. ![**github stars**](https://img.shields.io/github/stars/zeroclaw-labs/zeroclaw?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [kagent✨](https://github.com/kagent-dev/kagent): Agent framework for Kubernetes and cloud-native operations. ![**github stars**](https://img.shields.io/github/stars/kagent-dev/kagent?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [Universal-Commerce-Protocol/ucp✨](https://github.com/Universal-Commerce-Protocol/ucp): Specification and documentation for the Universal Commerce Protocol (UCP). [Dec 2025] ![**github stars**](https://img.shields.io/github/stars/Universal-Commerce-Protocol/ucp?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [Kreuzberg✨](https://github.com/kreuzberg-dev/kreuzberg): A polyglot document intelligence framework with a Rust core. [Jan 2025] ![**github stars**](https://img.shields.io/github/stars/kreuzberg-dev/kreuzberg?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [plano✨](https://github.com/katanemo/plano): AI-native proxy for agentic apps — model routing, observability, and guardrails, built on Envoy. [Jul 2024] ![**github stars**](https://img.shields.io/github/stars/katanemo/plano?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [arscontexta✨](https://github.com/agenticnotetaking/arscontexta): Builds a personal second-brain knowledge system from Claude Code conversations. [Feb 2026] ![**github stars**](https://img.shields.io/github/stars/agenticnotetaking/arscontexta?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [supermemory✨](https://github.com/supermemoryai/supermemory): Memory engine and app that is extremely fast, scalable. [Feb 2024] ![**github stars**](https://img.shields.io/github/stars/supermemoryai/supermemory?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [ext-apps✨](https://github.com/modelcontextprotocol/ext-apps): Spec & SDK for building interactive UIs (charts, forms) served inline by MCP tools. [Nov 2025] ![**github stars**](https://img.shields.io/github/stars/modelcontextprotocol/ext-apps?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [CLI-Anything✨](https://github.com/HKUDS/CLI-Anything): CLI-native agent for automating terminal-centric tasks. ![**github stars**](https://img.shields.io/github/stars/HKUDS/CLI-Anything?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [Kiro✨](https://github.com/kirodotdev/Kiro): AWS. Spec-Driven. an agentic IDE. [Jun 2025] ![**github stars**](https://img.shields.io/github/stars/kirodotdev/Kiro?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [nanobot✨](https://github.com/HKUDS/nanobot): Minimal coding agent in ~4,000 lines — 99% smaller than comparable agents. [Feb 2026] ![**github stars**](https://img.shields.io/github/stars/HKUDS/nanobot?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [nanocode✨](https://github.com/1rgs/nanocode): Minimal Claude Code alternative — single ~250-line Python file, zero dependencies. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/1rgs/nanocode?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [oh-my-opencode✨](https://github.com/code-yeongyu/oh-my-opencode): The Best Agent Harness. Meet Sisyphus: The Batteries-Included Agent that codes like you. [Dec 2025] ![**github stars**](https://img.shields.io/github/stars/code-yeongyu/oh-my-opencode?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [opencode✨](https://github.com/anomalyco/opencode): An open source coding agent. [Apr 2025] ![**github stars**](https://img.shields.io/github/stars/anomalyco/opencode?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [OpenHands✨](https://github.com/All-Hands-AI/OpenHands): OpenHands (formerly OpenDevin), a platform for software development agents [Mar 2024] ![**github stars**](https://img.shields.io/github/stars/All-Hands-AI/OpenHands?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [OpenSpec✨](https://github.com/Fission-AI/OpenSpec): Spec-driven development for AI coding assistants. ![**github stars**](https://img.shields.io/github/stars/Fission-AI/OpenSpec?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [opendev✨](https://github.com/opendev-to/opendev): Open-Source Coding Agent in the terminal. ![**github stars**](https://img.shields.io/github/stars/opendev-to/opendev?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [pi✨](https://github.com/badlogic/pi-mono): A terminal-friendly coding agent with minimal, clean design. [Aug 2025] ![**github stars**](https://img.shields.io/github/stars/badlogic/pi-mono?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [QueryWeaver✨](https://github.com/FalkorDB/QueryWeaver): An open-source Text2SQL tool that converts plain-English questions into SQL using graph-powered schema understanding. ![**github stars**](https://img.shields.io/github/stars/FalkorDB/QueryWeaver?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [SWE-CI✨](https://github.com/SKYLENAGE-AI/SWE-CI): Software engineering agent with CI-aware verification loops. ![**github stars**](https://img.shields.io/github/stars/SKYLENAGE-AI/SWE-CI?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [symphony✨](https://github.com/openai/symphony): Turns project work into isolated, autonomous implementation runs. ![**github stars**](https://img.shields.io/github/stars/openai/symphony?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [andrej-karpathy-skills✨](https://github.com/forrestchang/andrej-karpathy-skills): Karpathy-inspired CLAUDE.md with four principles: Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/forrestchang/andrej-karpathy-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [antigravity-awesome-skills✨](https://github.com/sickn33/antigravity-awesome-skills): 946+ agentic skills for Claude Code, Gemini CLI, Cursor, Copilot — one-command install via npx. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/sickn33/antigravity-awesome-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [Anthropic-Cybersecurity-Skills✨](https://github.com/mukul975/Anthropic-Cybersecurity-Skills): Security-oriented skills for Anthropic and Claude-based agents. ![**github stars**](https://img.shields.io/github/stars/mukul975/Anthropic-Cybersecurity-Skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [claude-scientific-skills✨](https://github.com/K-Dense-AI/claude-scientific-skills): A set of ready to use scientific skills for Claude [Oct 2025] ![**github stars**](https://img.shields.io/github/stars/K-Dense-AI/claude-scientific-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [claude-code-best-practice✨](https://github.com/shanraisshan/claude-code-best-practice): Claude Code best practices, prompts, and workflow rules. ![**github stars**](https://img.shields.io/github/stars/shanraisshan/claude-code-best-practice?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [claude-forge✨](https://github.com/sangrokjung/claude-forge): About
Supercharge Claude Code with 11 AI agents, 36 commands & 15 skills. ![**github stars**](https://img.shields.io/github/stars/sangrokjung/claude-forge?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [context-hub✨](https://github.com/andrewyng/context-hub): Curated, versioned docs and skills for coding agents. ![**github stars**](https://img.shields.io/github/stars/andrewyng/context-hub?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [everything-claude-code✨](https://github.com/affaan-m/everything-claude-code): Complete Claude Code configuration collection - agents, skills, hooks, commands, rules, MCPs. Battle-tested configs from an Anthropic hackathon winner. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/affaan-m/everything-claude-code?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [getsentry/skills✨](https://github.com/getsentry/skills): Skills for integrating Sentry workflows into coding agents. ![**github stars**](https://img.shields.io/github/stars/getsentry/skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [knowledge-work-plugins✨](https://github.com/anthropics/knowledge-work-plugins): 11 role-specific Cowork plugins (sales, legal, finance) with skills and MCP connectors. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/anthropics/knowledge-work-plugins?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [kimoring-ai-skills✨](https://github.com/codefactory-co/kimoring-ai-skills): Skill packs for Kimoring AI workflows and assistants. ![**github stars**](https://img.shields.io/github/stars/codefactory-co/kimoring-ai-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [last30days-skill✨](https://github.com/mvanhorn/last30days-skill): Time-window retrieval skill for recent knowledge and updates. ![**github stars**](https://img.shields.io/github/stars/mvanhorn/last30days-skill?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [mattpocock/skills✨](https://github.com/mattpocock/skills): TypeScript-heavy skills for coding agents and web apps. ![**github stars**](https://img.shields.io/github/stars/mattpocock/skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [notebooklm-skill✨](https://github.com/PleasePrompto/notebooklm-skill): NotebookLM integration skill for research and note synthesis. ![**github stars**](https://img.shields.io/github/stars/PleasePrompto/notebooklm-skill?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [obsidian-skills✨](https://github.com/kepano/obsidian-skills): A collection of skills and smart blocks for extending Obsidian functionality. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/kepano/obsidian-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [Planning with Files✨](https://github.com/OthmanAdi/planning-with-files): Claude Code skill implementing Manus-style persistent markdown planning [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/OthmanAdi/planning-with-files?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [Plugins Directory for Claude Code ✨](https://github.com/anthropics/claude-plugins-official): A curated directory of high-quality plugins for Claude Code. [Nov 2025] ![**github stars**](https://img.shields.io/github/stars/timescale/pg-aiguide?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [pm-skills✨](https://github.com/phuryn/pm-skills): Product management skills for planning and execution agents. ![**github stars**](https://img.shields.io/github/stars/phuryn/pm-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [skills🤗](https://github.com/huggingface/skills): Hugging Face skills for model training, evaluation, and Gradio UIs — compatible with Claude Code, Codex, Gemini CLI. [Nov 2025] ![**github stars**](https://img.shields.io/github/stars/huggingface/skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [superpowers✨](https://github.com/obra/superpowers): An agentic skills framework & software development methodology that works. [Oct 2025] ![**github stars**](https://img.shields.io/github/stars/obra/superpowers?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [vercel-agent-skills✨](https://github.com/vercel-labs/agent-skills): Vercel's official collection of agent skills [Dec 2025] ![**github stars**](https://img.shields.io/github/stars/vercel-labs/agent-skills?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [ai-hedge-fund✨](https://github.com/virattt/ai-hedge-fund): Multi-agent financial analysis and portfolio experimentation stack. ![**github stars**](https://img.shields.io/github/stars/virattt/ai-hedge-fund?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [garak✨](https://github.com/NVIDIA/garak): The LLM vulnerability scanner. ![**github stars**](https://img.shields.io/github/stars/NVIDIA/garak?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [SciSciGPT✨](https://github.com/Northwestern-CSSI/SciSciGPT): Advancing Human-AI Collaboration in the Science of Science. [Sep 2024] ![**github stars**](https://img.shields.io/github/stars/Northwestern-CSSI/SciSciGPT?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [TradingAgents✨](https://github.com/TauricResearch/TradingAgents): Multi-agent system for trading research and simulation. ![**github stars**](https://img.shields.io/github/stars/TauricResearch/TradingAgents?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [AutoResearchClaw✨](https://github.com/aiming-lab/AutoResearchClaw): Automated literature review and synthesis using agentic search. ![**github stars**](https://img.shields.io/github/stars/aiming-lab/AutoResearchClaw?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
1. [autoresearch✨](https://github.com/karpathy/autoresearch): Autonomous literature review and synthesis workflow for research tasks. ![**github stars**](https://img.shields.io/github/stars/karpathy/autoresearch?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [asta-theorizer✨](https://github.com/allenai/asta-theorizer): Generates scientific theories by synthesizing evidence from thousands of papers. [Jan 2026] ![**github stars**](https://img.shields.io/github/stars/allenai/asta-theorizer?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [notebooklm-py✨](https://github.com/teng-lin/notebooklm-py): Python interface for NotebookLM-style research workflows. ![**github stars**](https://img.shields.io/github/stars/teng-lin/notebooklm-py?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [OpenScholar✨](https://github.com/AkariAsai/OpenScholar): Retrieval-augmented LM that synthesizes scientific papers into grounded, cited responses. [Nov 2024] ![**github stars**](https://img.shields.io/github/stars/AkariAsai/OpenScholar?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
...
1. [paperclip✨](https://github.com/paperclipai/paperclip): Research paper analysis assistant with citation-aware workflows. ![**github stars**](https://img.shields.io/github/stars/paperclipai/paperclip?style=flat-square&label=%20&color=blue&cacheSeconds=36000)
