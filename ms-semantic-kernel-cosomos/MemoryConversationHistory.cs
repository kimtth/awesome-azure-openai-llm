...
internal class MemoryConversationHistory
{
    public async Task RunAsync()
    {
        ...
        SKContext summary = await kernel.RunAsync(ChatTranscript, conversationSummarySkill["SummarizeConversation"]).ConfigureAwait(true);
